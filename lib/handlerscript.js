...
createDeleteButton: function(){
  ...
  deleteButton.className = 'btn btn-dark deleteButton mt-2';
  return deleteButton;
},
...
createToggleButton: function(){
  ...
  toggleButton.className = 'btn btn-dark toggleButton mt-2';
  return toggleButton;
},
...
setupEventListeners: function(){
  ...
  if(elementClicked.className === 'btn btn-dark deleteButton mt-2')
  {
    handlers.DeleteTodo(parseInt(elementClicked.parentNode.id));
  }

  if(elementClicked.className === 'btn btn-dark toggleButton mt-2')
  {
